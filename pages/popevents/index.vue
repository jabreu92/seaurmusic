        ...
        .then(response => {
            ...
            this.popEvents = this.items._embedded.events
               ...
               for (let i =0; i<this.popEvents.length; i++){
                ...
                let date = new Date(this.popEvents[i].dates.start.localDate)
                this.popEvents[i].dates.start.localDate = date
